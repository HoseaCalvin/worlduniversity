...
function CountryCard(props) {
    ...
    return(
        <Link to={`/search/${encodeURIComponent(props.name)}`} onClick={handleClick}>
            <div className='border-neutral-800 border-2 bg-gray-100 rounded-md p-5 shadow-lg cursor-pointer hover:bg-gray-300 transition-colors duration-500'>
                <h1 className='text-[1.4rem] font-bold text-center'>{props.name}</h1>
                ...
                <div className='flex justify-between p-2'>
                    ...
                    <div className='text-right'>
                        ...
                        <p className='py-1 font-semibold'>{props.capital?.[0] || `N/A`}</p>
